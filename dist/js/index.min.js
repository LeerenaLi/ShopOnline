...
const menuBtn=document.querySelector(".header__btn"),menu=document.querySelector(".navigation");menuBtn.addEventListener("click",(({target:e})=>{menuBtn.classList.toggle("header__btn_active"),menu.classList.toggle("navigation_active")}));