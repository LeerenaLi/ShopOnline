...
const createElement=(e,a,{append:t,appends:n,parent:i,cb:r}={})=>{const s=document.createElement(e);return a&&Object.assign(s,a),t&&t instanceof HTMLElement&&s.append(t),n&&n.every((e=>e instanceof HTMLElement))&&s.append(...n),i&&i instanceof HTMLElement&&i.append(s),r&&"function"==typeof r&&r(s),s},API_URL="https://gorest.co.in/public/v1/posts",COUNT_PAGINATION=3,blogList=document.querySelector(".blog__list"),articleContainer=document.querySelector(".article__container"),wrapperPagination=document.querySelector(".pagination"),getData=async e=>{const a=new URL(e),t=await fetch(a);return await t.json()},getUrl=e=>{let a=window.location.pathname;const t=new URLSearchParams(a.search);for(const a in e)t.set(a,e[a]);return a+=`?${t.toString()}`,a},renderPagination=(e,a,t)=>{wrapperPagination.textContent="";const n=createElement("ul",{className:"pagination__list"},{parent:wrapperPagination}),i=e-Math.floor(t/2)>1,r=e+Math.floor(t/2)>=a;console.log("page: ",e),t>a&&(t=a);for(let s=0;s<t;s++){let l=s+1;i&&(l=r?a-t+s+1:e-Math.floor(t/2)+s),createElement("li",{className:"pagination__item"},{parent:n,append:createElement("a",{textContent:l,href:getUrl({page:l}),className:"pagination__link "+(l===e?"pagination__link_active":"")})})}a>t&&(createElement("a",{className:"pagination__arrow pagination__arrow_start\n                "+(i?"":"pagination__arrow_start-disabled"),href:getUrl({page:1}),tabIndex:i?"0":"-1",innerHTML:'\n                <svg width="29" height="19" viewbox="0 0 29 19" fill="none" xmlns="http://www.w3.org/2000/svg">\n                    <path d="M28.375 7.95833H6.52958L12.0487 2.42375L9.875 0.25L0.625 9.5L9.875 18.75L12.0487 16.5763L6.52958 11.0417H28.375V7.95833Z" fill="currentColor"/>\n                </svg>           \n            ',ariaLabel:"В начало"},{cb(e){wrapperPagination.prepend(e)}}),createElement("a",{className:"pagination__arrow pagination__arrow_end\n                "+(r?"pagination__arrow_end-disabled":""),href:getUrl({page:a}),tabIndex:r?"-1":"0",innerHTML:'\n                <svg width="29" height="19" viewbox="0 0 29 19" fill="none" xmlns="http://www.w3.org/2000/svg">\n                    <path d="M0.625 7.95833H22.4704L16.9513 2.42375L19.125 0.25L28.375 9.5L19.125 18.75L16.9513 16.5763L22.4704 11.0417H0.625V7.95833Z" fill="currentColor"/>\n                </svg>\n            ',ariaLabel:"В конец"},{parent:wrapperPagination}))},getAutor=async e=>{console.log("userID: ",e);const a=await fetch(`https://gorest.co.in/public-api/users/${e}`);return(await a.json()).data},createTemplate=async(e,a,t)=>{const n=await getAutor(t);console.log("dataAutor: ",n);const i=(r=1,s=13,Math.floor(Math.random()*(s-r))+r);var r,s;blogList.insertAdjacentHTML("beforeend",`\n        <li class="blog__item">\n            <img src="img/blog/${i}.jpg" class="blog__img">\n            <div class="blog__text">\n                <a href="article.html?id=${a}" id="${a}" class="blog__link">\n                    <div class="blog__descr">\n                        <h2 class="blog__title">${e.title}</h2>\n                        <p class="blog__body">${e.body}</p>\n                    </div>\n                </a>    \n                <div class="blog__scan">\n                    <p class="blog__count">Автор: \n                        <a href="#" class="blog__autor">${n.name}</a>\n                    </p>\n                </div>\n            </div>\n        </li>\n        \n    `)},getAtricle=async e=>{const a=await fetch(`https://gorest.co.in/public-api/posts/${e}`);return(await a.json()).data},createArticlePage=async(e,a,t)=>{const n=await getAutor(t);articleContainer.insertAdjacentHTML("beforeend",`\n        <div class="bread">\n            <a href="index.html" class="bread__link">Главная</a>\n                <img src="icons/blog/bread__right.svg" alt="arrow right" class="bread__img">\n            <a href="blog.html" class="bread__link">Блог</a>\n                <img src="icons/blog/bread__right.svg" alt="arrow right" class="bread__img">\n            <a href="article.html?id=${e}" class="bread__link">${a.title}</a>\n        </div>\n        <div class="article__wrapper">\n            <div class="article__text">\n                <div class="article__content">\n                    <div class="article__title">${a.title}</div>\n                    <p class="article__body">${a.body}</p>\n                </div>\n                <div class="article__footer">\n                    <a href="blog.html" class="article__back">\n                        <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">\n                            <path d="M21 11H6.83L10.41 7.41L9 6L3 12L9 18L10.41 16.59L6.83 13H21V11Z"/>\n                        </svg>\n                        <p class="article__link">К списку статей</p>\n                    </a>\n                    \n                    <div class="autor">\n                        <p class="autor__name">${n.name}</p>\n                        <a href="mailto:${n.email}" class="autor__email">E-mail: ${n.email}</a>\n                        <div class="autor__info">\n                            <p class="autor__status">Gender: ${n.gender}</p>\n                            <p class="autor__status">Status: ${n.status}</p>\n                        </div>\n                    </div>\n                </div>\n            </div>\n            <div class="article__marketing marketing">\n                <ul class="marketing__list">\n                    <li class="marketing__item">\n                        <picture class="marketing__image-wrapper">\n                            <source srcset="img/blog/marketing01_1024.avif" media="(max-width: 1200px)" type="image/avif">\n                            <source srcset="img/blog/marketing01_1024.webp" media="(max-width: 1200px)" type="image/webp">\n                            <source srcset="img/blog/marketing01_1024.jpg" media="(max-width: 1200px)"  width="300" height="254">\n                            <source srcset="img/blog/marketing01.avif" type="image/avif">\n                            <source srcset="img/blog/marketing01.webp" type="image/webp">\n                            <img src="img/blog/marketing01.jpg" alt="marketing" class="marketing__img" width="532" height="328">\n                        </picture>\n                        <div class="marketing__content">\n                            <p class="marketing__title">Горящие туры в&nbsp;Стамбул от&nbsp;20&nbsp;000&nbsp;руб.</p>\n                            <p class="marketing__text">Окунись в&nbsp;настоящую восточную сказку</p>\n                        </div>\n                    </li>\n\n                    <li class="marketing__item">\n                        <picture class="marketing__image-wrapper">\n                            <source srcset="img/blog/marketing02_1024.avif" media="(max-width: 1200px)" type="image/avif">\n                            <source srcset="img/blog/marketing02_1024.webp" media="(max-width: 1200px)" type="image/webp">\n                            <source srcset="img/blog/marketing02_1024.jpg" media="(max-width: 1200px)" width="300" height="254">\n                            <source srcset="img/blog/marketing02.avif" type="image/avif">\n                            <source srcset="img/blog/marketing02.webp" type="image/webp">\n                            <img src="img/blog/marketing01.jpg" alt="marketing" class="marketing__img" width="532" height="328">\n                        </picture>\n                        <div class="marketing__content">\n                            <p class="marketing__title">Новый RENAULT&nbsp;DUSTER</p>\n                            <p class="marketing__text">Легендарный внедорожник в&nbsp;новом дизайне</p>\n                        </div>\n                    </li>\n                </ul>\n            </div>\n        </div>\n    `)},createArticleLink=()=>{blogList.addEventListener("click",(async e=>{e.preventDefault();const a=e.target.closest("a").id;window.location.href=`article.html?id=${a}`}))},renderArticlePage=async()=>{blogList&&blogList.addEventListener("click",(async e=>{e.preventDefault();const a=e.target.closest("a").id;window.location.href=`article.html?id=${a}`}));const e=new URLSearchParams(window.location.search).get("id"),a=await getAtricle(e),t=a.user_id;createArticlePage(e,a,t)},renderPages=async()=>{let e=1;e=new URL(document.location).searchParams.get("page"),e=Number(e);const a=await getData(`${API_URL}?page=${e}`),t=a.meta.pagination.pages,n=a.data;n&&n.forEach((e=>{const a=e.id,t=e.user_id;console.log("autorId: ",t),blogList&&createTemplate(e,a,t)})),t&&t>1&&renderPagination(e,t,3)},init=()=>{blogList&&renderPages(),articleContainer&&renderArticlePage()};blogList&&renderPages(),articleContainer&&renderArticlePage();
